def get_morse_code_dict():
    """Returns a dictionary mapping alphanumeric characters and space to Morse code."""
    return {
        " ": "/",
        "A": ".-",
        "B": "-...",
...
def validate_input(args):
    ...
    Raises:
        AssertionError: If the number of arguments is not 2 or if any character is invalid.
    """
    if len(args) != 2:
